...
window.GameData = (function(){
  ...
  const SPOTS = [
    ...
    { id:'chungju',   name:'충주호',          country:'대한민국', lat:36.98, lon:128.05, biome:'kr_fresh', water:'lake_green', start:2.8, relief:700, shore:2 },
    { id:'andong',    name:'안동호',          country:'대한민국', lat:36.60, lon:128.85, biome:'kr_fresh', water:'lake_clear', start:2.4, relief:600, shore:2 },
    { id:'nakdong',   name:'낙동강 하류',     country:'대한민국', lat:35.30, lon:128.95, biome:'kr_fresh', water:'lake_green', start:2, relief:300, shore:1.5 },
    { id:'geoje',     name:'거제 앞바다',     country:'대한민국', lat:34.75, lon:128.70, biome:'temp_sea', water:'sea_temp', start:4, relief:600 },
    { id:'taean',     name:'태안 앞바다',     country:'대한민국', lat:36.70, lon:126.05, biome:'temp_sea', water:'sea_temp', start:3, relief:200 },
    { id:'dokdo',     name:'독도 근해',       country:'대한민국', lat:37.24, lon:131.87, biome:'temp_sea', water:'sea_temp', start:8, relief:170 },
    { id:'kasumi',    name:'가스미가우라',     country:'일본', lat:36.05, lon:140.40, biome:'kr_fresh', water:'lake_green', start:2, relief:80, shore:8 },
    { id:'okinawa',   name:'오키나와 앞바다',  country:'일본', lat:26.30, lon:127.60, biome:'trop_sea', water:'sea_trop', start:3, relief:400 },
    { id:'baikal',    name:'바이칼 호',       country:'러시아', lat:53.50, lon:108.00, biome:'cold_fresh', water:'cold_lake', start:4, relief:1800, shore:30 },
    { id:'mekong',    name:'메콩 강',         country:'캄보디아', lat:12.50, lon:105.95, biome:'trop_fresh', water:'river_brown', start:3, relief:60, shore:1.5 },
    { id:'andaman',   name:'안다만 해',       country:'태국', lat:7.80, lon:98.30, biome:'trop_sea', water:'sea_trop', start:3, relief:500 },
    { id:'bali',      name:'발리 앞바다',     country:'인도네시아', lat:-8.80, lon:115.20, biome:'trop_sea', water:'sea_trop', start:4, relief:2500 },
    { id:'redsea',    name:'홍해',            country:'이집트', lat:27.20, lon:34.00, biome:'trop_sea', water:'sea_trop', start:4, relief:1200 },
    { id:'seychelles',name:'세이셸 제도',     country:'세이셸', lat:-4.60, lon:55.50, biome:'trop_sea', water:'sea_trop', start:3, relief:500 },
    { id:'mozambique',name:'모잠비크 해협',   country:'모잠비크', lat:-21.50, lon:40.00, biome:'trop_sea', water:'sea_trop', start:10, relief:20 },
    { id:'capetown',  name:'희망봉 앞바다',   country:'남아프리카', lat:-34.40, lon:18.30, biome:'temp_sea', water:'sea_temp', start:5, relief:1000 },
    { id:'nile',      name:'나세르 호',       country:'이집트', lat:22.80, lon:32.40, biome:'trop_fresh', water:'lake_green', start:3, relief:300, shore:6 },
    { id:'scotland',  name:'네스 호',         country:'영국', lat:57.30, lon:-4.45, biome:'cold_fresh', water:'cold_lake', start:4, relief:700, shore:1.5 },
    { id:'ireland',   name:'아일랜드 서해',   country:'아일랜드', lat:53.20, lon:-10.20, biome:'temp_sea', water:'sea_temp', start:5, relief:600 },
    { id:'iceland',   name:'아이슬란드 근해', country:'아이슬란드', lat:63.30, lon:-21.50, biome:'cold_sea', water:'sea_cold', start:8, relief:1400 },
    { id:'azores',    name:'아조레스 제도',   country:'포르투갈', lat:38.60, lon:-28.70, biome:'temp_sea', water:'sea_temp', start:8, relief:2300 },
    { id:'grandbanks',name:'그랜드뱅크스',    country:'캐나다 (원양)', lat:45.00, lon:-50.50, biome:'cold_sea', water:'sea_cold', start:10, relief:5 },
    { id:'bahamas',   name:'바하마',          country:'바하마', lat:24.60, lon:-77.40, biome:'trop_sea', water:'sea_trop', start:2, relief:20 },
    { id:'cabo',      name:'카보산루카스',    country:'멕시코', lat:22.85, lon:-109.90, biome:'trop_sea', water:'sea_trop', start:6, relief:1500 },
    { id:'tahoe',     name:'타호 호',         country:'미국', lat:39.10, lon:-120.05, biome:'na_fresh', water:'lake_clear', start:3, relief:2800, shore:5 },
    { id:'mississippi',name:'미시시피 강',    country:'미국', lat:35.10, lon:-90.10, biome:'na_fresh', water:'river_brown', start:3, relief:60, shore:1.5 },
    { id:'yukon',     name:'유콘 강',         country:'캐나다', lat:62.00, lon:-136.50, biome:'cold_fresh', water:'cold_lake', start:3, relief:1200, shore:1.5 },
    { id:'bering',    name:'베링 해',         country:'미국 (원양)', lat:57.50, lon:-172.00, biome:'cold_sea', water:'sea_cold', start:12, relief:5 },
    { id:'galapagos', name:'갈라파고스',      country:'에콰도르', lat:-0.70, lon:-90.50, biome:'trop_sea', water:'sea_trop', start:5, relief:1300 },
    { id:'titicaca',  name:'티티카카 호',     country:'페루', lat:-15.80, lon:-69.40, biome:'cold_fresh', water:'cold_lake', start:3, relief:2500, shore:8 },
    { id:'pantanal',  name:'판타나우',        country:'브라질', lat:-18.00, lon:-57.50, biome:'trop_fresh', water:'river_brown', start:2, relief:40, shore:1.2 },
    { id:'fiji',      name:'피지 앞바다',     country:'피지', lat:-17.80, lon:178.00, biome:'trop_sea', water:'sea_trop', start:4, relief:900 },
    { id:'nz',        name:'뉴질랜드 베이오브아일랜즈', country:'뉴질랜드', lat:-35.20, lon:174.20, biome:'temp_sea', water:'sea_temp', start:5, relief:500 },
    { id:'tasmania',  name:'태즈메이니아',    country:'호주', lat:-43.10, lon:147.90, biome:'temp_sea', water:'sea_temp', start:5, relief:900 },
    { id:'midpacific',name:'태평양 한가운데', country:'공해 (원양)', lat:10.00, lon:-140.00, biome:'trop_sea', water:'sea_trop', start:14, relief:0 },
  ];
